    ...
    <div className="max-w-2xl mx-auto p-4 mt-10">
      <Window title="ERROR 404">
        <div className="font-mono text-xs p-4 space-y-3">
          <div className="text-danger-500 font-bold">
            SYSTEM ERROR: ROUTE NOT FOUND
          </div>
          <div className="text-muted-400">
            <pre className="whitespace-pre-wrap text-danger-400">{`ERROR_CODE: 404
...
STATUS: missing`}</pre>
          ...
          <div className="pt-2 flex gap-3">
            ...
            <Link to="/play" className="text-success-400 hover:underline">
              &gt; go to play
            </Link>
          </div>
        </div>
