...
export function useAuth() {
    const [isLoggedIn, setIsLoggedIn] = useState(!!sessionStorage.getItem('azahar_player_jwt'));
    const [playerName, setPlayerName] = useState(sessionStorage.getItem('azahar_player_name'));
    const [isAdmin, setIsAdmin] = useState(!!sessionStorage.getItem('azahar_admin_jwt'));
    ...
    return { isLoggedIn, playerName, isAdmin, login, logout, adminLogin, adminLogout };
}
